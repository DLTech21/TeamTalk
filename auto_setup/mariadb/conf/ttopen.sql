...
CREATE TABLE `IMMessage_0` (
  ...
  `type` tinyint(2) unsigned NOT NULL DEFAULT '1' COMMENT '消息类型 MSG_TYPE_SINGLE_TEXT    = 0x01;
    MSG_TYPE_SINGLE_AUDIO   = 0x02;
    MSG_TYPE_SINGLE_IMAGE    = 0x03;
    MSG_TYPE_SINGLE_LOCATION   = 0x04;
    MSG_TYPE_SINGLE_VIDEO    = 0x05;
    MSG_TYPE_SINGLE_URL   = 0x06;
    MSG_TYPE_SINGLE_FILE   = 0x07;
    MSG_TYPE_SINGLE_EMOTION   = 0x08;',
