...
public class LocationCheckActivity extends TTBaseActivity implements OnClickListener{
    ...
    public class MyLocationListenner implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            com.mogujie.tt.utils.ViewUtils.dismissProgressDialog();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.left_txt:
                ...
                break;
            case R.id.btnNav:
                com.mogujie.tt.utils.ViewUtils.createProgressDialog(getRunningActivity(), "正在确定位置...", ThemeUtils.getThemeColor()).show();
                if (mLocClient != null) {
                    mLocClient.start();
                }
                break;
