...
({\
bool bRet = false;\
if ((IM::BaseDefine::MSG_TYPE_SINGLE_TEXT == type) || (IM::BaseDefine::MSG_TYPE_SINGLE_AUDIO == type) || (IM::BaseDefine::MSG_TYPE_SINGLE_IMAGE == type) || (IM::BaseDefine::MSG_TYPE_SINGLE_LOCATION == type) || (IM::BaseDefine::MSG_TYPE_SINGLE_VIDEO == type) || (IM::BaseDefine::MSG_TYPE_SINGLE_URL == type) || (IM::BaseDefine::MSG_TYPE_SINGLE_FILE == type)  || (IM::BaseDefine::MSG_TYPE_SINGLE_EMOTION == type))\
{\
bRet = true;\
}\
bRet;\
...
({\
bool bRet = false;\
if ((IM::BaseDefine::MSG_TYPE_GROUP_TEXT == type) || (IM::BaseDefine::MSG_TYPE_GROUP_AUDIO == type) || (IM::BaseDefine::MSG_TYPE_GROUP_IMAGE == type) || (IM::BaseDefine::MSG_TYPE_GROUP_LOCATION == type) || (IM::BaseDefine::MSG_TYPE_GROUP_VIDEO == type) || (IM::BaseDefine::MSG_TYPE_GROUP_URL == type) || (IM::BaseDefine::MSG_TYPE_GROUP_FILE == type) || (IM::BaseDefine::MSG_TYPE_GROUP_EMOTION == type) )\
{\
bRet = true;\
}\
bRet;\
